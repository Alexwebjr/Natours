...
var showAlert = function showAlert(type, msg) {
  hideAlert(); //hide old alert

  var markup = "<div class=\"alert alert--".concat(type, "\">").concat(msg, "</div>");
  document.querySelector('body').insertAdjacentHTML('afterbegin', markup);
  window.setTimeout(hideAlert, 5000); //hideAlert
};
...
var userDataSaveBtn = document.querySelector('.btn--save-settings');
var userPasswordSaveBtn = document.querySelector('.btn--save-password'); //Delegation
...
if (logOutBtn) logOutBtn.addEventListener('click', _login.logout); //On UpdateMe Submit
